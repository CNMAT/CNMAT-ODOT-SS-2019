...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 645.000017821788788, 16.666668951511383, 22.0, 140.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 598.000017821788788, 16.666668951511383, 22.0, 140.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 598.000017821788788, 167.333337903022766, 45.0, 45.0 ]
				}
...
, 			{
				"name" : "o.rye~.maxpat",
				"bootpath" : "~/Development/CNMAT/CNMAT-ODOT-SS-2019/patchers",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
